...
$Params = @{
    ...
    Settings          = @{fileUris = @('https://raw.githubusercontent.com/panik10/azure_task_12_deploy_app_with_vm_extention/refs/heads/main/install-app.sh'); commandToExecute = './install-app.sh'}
}
